...
abstract class DigitalWallet {
    ...
    abstract void addMoney(long amount, int upiId) throws InvalidAmountException;

    abstract void addMoney(long amount, String cardNumber) throws InvalidAmountException;

    abstract void transfer(long amount, String remarks) throws InvalidAmountException;

    abstract void transfer(long amount) throws InvalidAmountException;
